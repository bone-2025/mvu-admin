...
import type {
  ...
  DeleteUserPhoneData,
  DeleteUserPhoneErrors,
  DeleteUserPhoneResponses,
  ...
  ListUserPhonesData,
  ListUserPhonesErrors,
  ListUserPhonesResponses,
...
import {
  ...
  vDeleteUserPhoneData,
  vDeleteUserPhoneResponse,
 ...
 * List user phones
 *
 * Retrieve a list of user phones.
 */
export const listUserPhones = <ThrowOnError extends boolean = false>(
  options: Options<ListUserPhonesData, ThrowOnError>,
) =>
  options.client.get<
    ListUserPhonesResponses,
    ListUserPhonesErrors,
  ...
  >({
    requestValidator: async (data) =>
      await v.parseAsync(vListUserPhonesData, data),
    responseValidator: async (data) =>
      await v.parseAsync(vListUserPhonesResponse, data),
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * Note that this endpoint ignores any policy which would normally prevent the phone from being added.
 */
export const addUserPhone = <ThrowOnError extends boolean = false>(
  options: Options<AddUserPhoneData, ThrowOnError>,
) =>
  options.client.post<AddUserPhoneResponses, AddUserPhoneErrors, ThrowOnError>({
    requestValidator: async (data) =>
      await v.parseAsync(vAddUserPhoneData, data),
    responseValidator: async (data) =>
      await v.parseAsync(vAddUserPhoneResponse, data),
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/v1/user-phones",
    ...options,
    headers: {
 ...
 * Delete a user phone
 */
export const deleteUserPhone = <ThrowOnError extends boolean = false>(
  options: Options<DeleteUserPhoneData, ThrowOnError>,
) =>
  options.client.delete<
    DeleteUserPhoneResponses,
    DeleteUserPhoneErrors,
  ...
  >({
    requestValidator: async (data) =>
      await v.parseAsync(vDeleteUserPhoneData, data),
    responseValidator: async (data) =>
      await v.parseAsync(vDeleteUserPhoneResponse, data),
    security: [{ scheme: "bearer", type: "http" }],
 ...
 * Get a user phone
 */
export const getUserPhone = <ThrowOnError extends boolean = false>(
  options: Options<GetUserPhoneData, ThrowOnError>,
) =>
  options.client.get<GetUserPhoneResponses, GetUserPhoneErrors, ThrowOnError>({
    requestValidator: async (data) =>
      await v.parseAsync(vGetUserPhoneData, data),
    responseValidator: async (data) =>
      await v.parseAsync(vGetUserPhoneResponse, data),
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/admin/v1/user-phones/{id}",
    ...options,
  });
