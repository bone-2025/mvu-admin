...
export type UserPhoneFilter = {
  ...
  "filter[user]"?: Ulid | null;
  /**
   * Retrieve the user phone with the given phone number
   */
 ...
 * A top-level response with a page of resources
 */
export type PaginatedResponseForUserPhone = {
  /**
   * Response metadata
   */
  meta?: PaginationMeta | null;
   ...
   * The list of resources
   */
  data?: Array<SingleResourceForUserPhone> | null;
  /**
   * Related links
   */
  links: PaginationLinks;
 ...
 * A single resource, with its type, ID, attributes and related links
 */
export type SingleResourceForUserPhone = {
  /**
   * The type of the resource
   */
  type: string;
...
export type UserPhone = {
  ...
  created_at: string;
  /**
   * The ID of the user who owns this phone number
   */
  user_id: Ulid;
  /**
   * The phone number
...
/**
 * JSON payload for the `POST /api/admin/v1/user-phones`
 */
export type AddUserPhoneRequest = {
  /**
   * The ID of the user to which the phone should be added.
   */
  user_id: Ulid;
  /**
   * The phone number of the user to add.
   */
  phone: string;
};
 ...
 * A top-level response with a single resource
 */
export type SingleResponseForUserPhone = {
  data: SingleResourceForUserPhone;
  links: SelfLinks;
};

export type ListUserPhonesData = {
  body?: never;
  path?: never;
  query?: {
    /**
  ...
  url: "/api/admin/v1/user-phones";
};

export type ListUserPhonesErrors = {
  /**
   * Bad request
   */
  400: ErrorResponse;
...
export type ListUserPhonesError =
  ListUserPhonesErrors[keyof ListUserPhonesErrors];

export type ListUserPhonesResponses = {
  /**
   * Paginated response of user phones
   */
  200: PaginatedResponseForUserPhone;
};

export type ListUserPhonesResponse =
  ListUserPhonesResponses[keyof ListUserPhonesResponses];

export type AddUserPhoneData = {
  body: AddUserPhoneRequest;
  path?: never;
  query?: never;
  url: "/api/admin/v1/user-phones";
};

export type AddUserPhoneErrors = {
  /**
   * Phone is not valid
   */
  400: ErrorResponse;
...
export type AddUserPhoneError = AddUserPhoneErrors[keyof AddUserPhoneErrors];

export type AddUserPhoneResponses = {
  /**
   * User phone was created
   */
  201: SingleResponseForUserPhone;
};

export type AddUserPhoneResponse =
  AddUserPhoneResponses[keyof AddUserPhoneResponses];

export type DeleteUserPhoneData = {
  body?: never;
  path: {
    /**
     * The ID of the resource
  ...
  query?: never;
  url: "/api/admin/v1/user-phones/{id}";
};

export type DeleteUserPhoneErrors = {
  /**
   * User phone was not found
   */
  404: ErrorResponse;
};

export type DeleteUserPhoneError =
  DeleteUserPhoneErrors[keyof DeleteUserPhoneErrors];

export type DeleteUserPhoneResponses = {
  /**
   * User phone was found
   */
  204: void;
};

export type DeleteUserPhoneResponse =
  DeleteUserPhoneResponses[keyof DeleteUserPhoneResponses];

export type GetUserPhoneData = {
  body?: never;
  path: {
    /**
     * The ID of the resource
...
export type GetUserPhoneErrors = {
  /**
   * User phone was not found
   */
  404: ErrorResponse;
...
export type GetUserPhoneError = GetUserPhoneErrors[keyof GetUserPhoneErrors];

export type GetUserPhoneResponses = {
  /**
   * User phone was found
   */
  200: SingleResponseForUserPhone;
};

export type GetUserPhoneResponse =
  GetUserPhoneResponses[keyof GetUserPhoneResponses];
