 ...
 */
export const vUserPhone = v.object({
  created_at: v.pipe(v.string(), v.isoTimestamp()),
  user_id: vUlid,
  phone: v.string(),
});
 ...
 * A single resource, with its type, ID, attributes and related links
 */
export const vSingleResourceForUserPhone = v.object({
  type: v.string(),
  id: vUlid,
  attributes: vUserPhone,
  links: vSelfLinks,
  meta: v.optional(v.union([vSingleResourceMeta, v.null()])),
});
 ...
 * A top-level response with a page of resources
 */
export const vPaginatedResponseForUserPhone = v.object({
  meta: v.optional(v.union([vPaginationMeta, v.null()])),
  data: v.optional(v.union([v.array(vSingleResourceForUserPhone), v.null()])),
  links: vPaginationLinks,
});
 ...
 */
export const vAddUserPhoneRequest = v.object({
  user_id: vUlid,
  phone: v.string(),
});
 ...
 * A top-level response with a single resource
 */
export const vSingleResponseForUserPhone = v.object({
  data: vSingleResourceForUserPhone,
  links: vSelfLinks,
});

export const vListUserPhonesData = v.object({
  ...
  query: v.optional(
    v.object({
      ...
      count: v.optional(v.union([vIncludeCount, v.null()])),
      "filter[user]": v.optional(v.union([vUlid, v.null()])),
      "filter[phone]": v.optional(v.union([v.string(), v.null()])),
    }),
  ),
});
 ...
 */
export const vListUserPhonesResponse = vPaginatedResponseForUserPhone;

export const vAddUserPhoneData = v.object({
  body: vAddUserPhoneRequest,
  path: v.optional(v.never()),
 ...
 */
export const vAddUserPhoneResponse = vSingleResponseForUserPhone;

export const vDeleteUserPhoneData = v.object({
  body: v.optional(v.never()),
  path: v.object({
    id: vUlid,
  }),
 ...
 */
export const vDeleteUserPhoneResponse = v.void();

export const vGetUserPhoneData = v.object({
  body: v.optional(v.never()),
  path: v.object({
    id: vUlid,
  }),
 ...
 * User phone was found
 */
export const vGetUserPhoneResponse = vSingleResponseForUserPhone;
