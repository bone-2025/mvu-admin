      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          if (user.attributes.deactivated_at) {
            return <Badge kind="red">已停用</Badge>;
          }

          if (user.attributes.locked_at) {
            return <Badge kind="grey">已锁定</Badge>;
          }

          if (user.attributes.legacy_guest) {
            return <Badge kind="grey">访客</Badge>;
          }

          if (user.attributes.admin) {
            return <Badge kind="green">管理员</Badge>;
          }

          return <Badge kind="default">活跃</Badge>;
        },
      },
    ],
